...
const Footer = () => {
    return (
        <div className="sm:h-16 h-36 w-full flex text-gray-400  text-lg flex-col justify-betwen bg-gray-900/5 sm:flex-row  p-4 sm:p-0 ">
            {/* github, resume, linkedin */}
            <div className="h-full w-1/2 sm:w-1/2 ">
                <ul className="flex w-full h-full items-center flex-col sm:flex-row  sm:pl-24">
