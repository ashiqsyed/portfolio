    ...
    return (
        <nav className="h-16 w-full min-w-screen flex items-center justify-between text-gray-100 bg-gray-800 sticky top-0 z-5">
            ...
            <div className="flex items-center justify-around text-center  h-full w-1/2 text-xl invisible sm:visible">
                {page === 'about' ? <div className="h-full bg-gray-500 w-1/3 flex items-center justify-center hover:bg-gray-500 transition duration-150" onClick={handleAboutClick}>about</div> : <div className="h-full bg-gray-800 w-1/3 flex items-center justify-center hover:bg-gray-500 transition duration-150" onClick={handleAboutClick}>about</div> }   
                {page === 'projects' ? <div className="h-full bg-gray-500 w-1/3 flex items-center justify-center hover:bg-gray-500 transition duration-150" onClick={handleProjectsClick}>projects</div> : <div className="h-full bg-gray-800 w-1/3 flex items-center justify-center hover:bg-gray-500 transition duration-150" onClick={handleProjectsClick}>projects</div> }                   
                {page === 'contact' ? <div className="h-full bg-gray-500 w-1/3 flex items-center justify-center hover:bg-gray-500 transition duration-150" onClick={handleContactClick}>contact</div> : <div className="h-full bg-gray-800 w-1/3 flex items-center justify-center hover:bg-gray-500 transition duration-150" onClick={handleContactClick}>contact</div> }                   
            </div>
