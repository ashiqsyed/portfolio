...
export default function Home() {
  ...
  return (
      <div className=" w-full sm:py-16  flex justify-center sm:max-2xl:h-[575px]"> 
        ...
        <div className="text-gray-100 sm:w-1/2 w-3/4 flex flex-col h-full  justify-center sm:py-16 my-12">
            <TextEffect className="text-2xl my-0  w-full text-center " per="line" preset="fade-in-blur" speedReveal={0.6} >
              Hello, I&apos;m
            </TextEffect>
            <TextEffect className="text-6xl sm:my-4 flex items-center justify-center text-center w-full h-32 text-shadow-[7px_7px_7px_rgba(59,130,246,10)]" per="char" speedSegment={0.25} preset="slide" delay={1}>
              Ashiq Syed
            </TextEffect>
