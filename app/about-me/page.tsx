...
export default function AboutMe() {
    ...
    return (
        <div className="bg-gray-900 text-gray-100 flex items-center justify-center ">
            ...
            {/* first third */}
                <div className="w-full flex m-8 p-8">
                    ...
                    <div className="w-1/3 flex flex-col items-center justify-center m-2">
                ...
                <div className="w-full flex m-8 p-8">
                    ...
                    <div className="w-1/3 h-full  flex items-center justify-center ml-8">
                ...
                <div className="w-full flex items-center justify-center m-8 p-8">
                    <iframe className="w-1/2" src="https://open.spotify.com/embed/playlist/1tgoewEoIaoLZHfVxi3Upz?utm_source=generator" width="100%" height="352"  allowFullScreen allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>
                </div>
            </div>
