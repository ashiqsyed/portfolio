        ...
        <div className="bg-gray-900 text-gray-100 flex items-center justify-center flex-col min-h-screen">
            ...
            {/* first third */}
                ...
                <div className="w-full flex m-8 p-8 sm:flex-row flex-col">
                    <div className="sm:w-2/3 flex justify-center items-center text-center sm:text-left ">
                        <div>
                    ...
                    <div className="sm:w-1/3 h-full flex items-center justify-center sm:ml-8 ml-4 md:max-xl:ml-16">
